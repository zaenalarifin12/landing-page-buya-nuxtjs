        ...
        <div class="py-4 pt-32 lg:pt-48">
            <div class="">
                ...
                <div  class="flex flex-wrap justify-evenly bg-white py-4 px-0 lg:px-10">
                    <div v-for="(index) in 70" :key="index" class="w-2/5 md:w-1/3 lg:w-1/5 p-3 my-6 mx-1 md:mx-2 lg:mx-2 bg-white rounded-lg flex flex-col justify-between shadow-lg hover:shadow-2xl">
                        <img class="mx-auto rounded-lg" :src="'/images/' + index  + '-min.jpg'" alt="" srcset="">
                    </div>
                </div>
